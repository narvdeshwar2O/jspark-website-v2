    ...
    <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col items-center justify-center bg-black">
      ...
      <motion.div
        ...
        <motion.div
          ...
          <motion.div
            variants={bootItem}
            className="flex flex-row flex-wrap items-center justify-center gap-4 md:gap-8 w-full max-w-4xl text-[10px] md:text-[11px] font-mono text-zinc-400 tracking-widest mt-16 px-4">
