...
const stats = [
{ value: "24 Cr", label: "Citizens protected under UP 112, live across all 75 districts", tag: "SYS.01" },
{ value: "1.34 Cr", label: "Fingerprint records comprehended inside NCRB NAFIS", tag: "SYS.02" },
{ value: "3M+", label: "Rivers and streams mapped by India's first AI hydrology model", tag: "SYS.03" },
{ value: "5 sec", label: "National crime report generation, down from 10 hours", tag: "SYS.04" },
{ value: "23% > 4%", label: "Misrouted emergency calls, corrected at intake", tag: "SYS.05" },
...
function StatCard({ stat, itemVariants }) {
  ...
  return (
    <motion.div
      ...
      <div className="text-5xl md:text-7xl font-black tracking-tighter text-white mb-6 group-hover:text-[#FF5722] group-hover:drop-shadow-[0_0_15px_rgba(255,87,34,0.3)] transition-all duration-300 relative z-10 flex">
    ...
    <section className="relative w-full bg-[#000000] py-32 border-t border-zinc-900 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
        ...
        <motion.div
          ...
          className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[1px] bg-zinc-900/50 border border-zinc-800/50 group/grid"
          variants={container}
          initial="hidden"
          whileInView="show"
